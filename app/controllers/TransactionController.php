    ...
    public function saveAction()
    {
        ...
        try {
            ...
            for ($i=0; $i < count($collection); $i++) {                 
                ...
                $sqlValuePart = $sqlValuePart . ($filter->sanitize($slip['customer_reference_identifier'], 'string') == '' ? 'null' : '\''. subtr($filter->sanitize($slip['customer_reference_identifier'], 'string'), 17) . '\'') . ',';
